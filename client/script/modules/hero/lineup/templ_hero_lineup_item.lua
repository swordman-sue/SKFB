...
Modules.TemplHeroLineupItem = Modules.TemplHeroLineupItem or BaseClass(GUI.ScrollItem)

function Modules.TemplHeroLineupItem:__init()
...
function Modules.TemplHeroLineupItem:__delete()
end

function Modules.TemplHeroLineupItem:GetTouchNode()
...
--[[
	hero_info
--]]
function Modules.TemplHeroLineupItem:SetData(data)
