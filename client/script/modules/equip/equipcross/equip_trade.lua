...
Modules.EquipTradeView = Modules.EquipTradeView or BaseClass(BaseView)

function Modules.EquipTradeView:__init()
    self.__layout_name = "equipdetails"  
    self.__type = BaseViewType.EQUIPLIST
...
function Modules.EquipTradeView:__Dispose()
...
function Modules.EquipTradeView:__OpenCallback()
    --标题
    -- self:__Getwidget()
    -- self:__ShowUI()
end

function Modules.EquipTradeView:__Getwidget( ... )
   
end

function Modules.EquipTradeView:__ShowUI( ... )
    self.trde = Modules.TemplTrade.New(unpack(self.__open_data),function ()
        self:OnClose()
    end)
end

function Modules.EquipTradeView:SetlistCell( ... )
  
end

function Modules.EquipTradeView:OnClose( ... )
    self:DeleteMe()
end
