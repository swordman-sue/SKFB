...
%% @module: 领地副本结算
%% @author: yjg
%% @created: 2018年12月13日11:23:25
--]]

Modules = Modules or {}

Modules.ManorDareResultWinView = Modules.ManorDareResultWinView or BaseClass( Modules.SpBattleResultWinBase )

function Modules.ManorDareResultWinView:__init()
end

function Modules.ManorDareResultWinView:__OpenCallback()
...
function Modules.ManorDareResultWinView:__Dispose()
end

--上方信息
function Modules.ManorDareResultWinView:__ShowTopInfo()
...
--战斗奖励
function Modules.ManorDareResultWinView:__ShowCommonRewards( end_callback )
...
--额外奖励
function Modules.ManorDareResultWinView:__ShowExtraRewards()
