...
Modules.TeamNormalResultWinView = Modules.TeamNormalResultWinView or BaseClass( Modules.SpBattleResultWinBase )

function Modules.TeamNormalResultWinView:__init()
end

function Modules.TeamNormalResultWinView:__OpenCallback()
	Modules.SpBattleResultWinBase.__OpenCallback(self)
	
	self:__ShowTopInfo()
end

function Modules.TeamNormalResultWinView:__Dispose()
end

--上方信息
function Modules.TeamNormalResultWinView:__ShowTopInfo()
...
--战斗奖励
function Modules.TeamNormalResultWinView:__ShowCommonRewards( end_callback )
...
--额外奖励
function Modules.TeamNormalResultWinView:__ShowExtraRewards()
