GUI = GUI or {}
GUI.TemplPlunderedTreasuresOneKeyCell = GUI.TemplPlunderedTreasuresOneKeyCell or BaseClass(GUI.Template)

function GUI.TemplPlunderedTreasuresOneKeyCell:__init(data)
	self:InitTemplate(GUI.TemplateRegistry.PLUNDERED_TREASURES_REPORT)
	self:createMainUI(data)
end

function GUI.TemplPlunderedTreasuresOneKeyCell:__AddToParent()

end
function GUI.TemplPlunderedTreasuresOneKeyCell:createMainUI(data)
	if not data then
		return
	end
	self.__data = data
...
function GUI.TemplPlunderedTreasuresOneKeyCell:__delete()
