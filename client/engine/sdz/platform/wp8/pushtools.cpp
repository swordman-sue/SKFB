...
std::string PushTools::InvokePushTaskMethod(const char* taskTime, const char* taskName, const char* taskLast, const char* preTime, const char* timer)
{
	return "win";
}
...
std::string PushTools::SetTimerTask(const char* taskTime, const char* taskName, const char* taskLast, const char* preTime, const char* timer)
{
	return InvokePushTaskMethod(taskTime, taskName, taskLast, preTime, timer);
}

std::string PushTools::CancelTimerTask(const char* taskTime)
{
	return InvokeVoidPushMethod("CANCELTASK", taskTime);
}
