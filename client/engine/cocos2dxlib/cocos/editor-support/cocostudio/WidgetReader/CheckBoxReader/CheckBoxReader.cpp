...
//            }
    ...
    void CheckBoxReader::setPropsWithFlatBuffers(cocos2d::Node *node, const flatbuffers::Table *checkBoxOptions)
    {
		...
		int backGroundType = 1;//backGroundDic->resourceType();// 强制使用PLIST类型 edit by swordman sue 2016-7-30
		...
		int backGroundSelectedType = 1;//backGroundSelectedDic->resourceType();// 强制使用PLIST类型 edit by swordman sue 2016-7-30
		...
		int frontCrossType = 1;// frontCrossDic->resourceType();// 强制使用PLIST类型 edit by swordman sue 2016-7-30
		...
		int backGroundDisabledType = 1;// backGroundDisabledDic->resourceType();// 强制使用PLIST类型 edit by swordman sue 2016-7-30
		...
		int frontCrossDisabledType = 1;// frontCrossDisabledDic->resourceType();// 强制使用PLIST类型 edit by swordman sue 2016-7-30
