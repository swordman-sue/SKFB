...
//        bool bt = DICTOOL->checkObjectExist_json(options, P_BarFileName);
    ...
    void SliderReader::setPropsWithFlatBuffers(cocos2d::Node *node, const flatbuffers::Table *sliderOptions)
    {
		...
		int imageFileNameType = 1;// imageFileNameDic->resourceType();// 强制使用PLIST类型 edit by swordman sue 2016-7-30
		...
		int normalType = 1;// normalDic->resourceType();// 强制使用PLIST类型 edit by swordman sue 2016-7-30
		...
		int pressedType = 1;// pressedDic->resourceType();// 强制使用PLIST类型 edit by swordman sue 2016-7-30
		...
		int disabledType = 1;// disabledDic->resourceType();// 强制使用PLIST类型 edit by swordman sue 2016-7-30
		...
		int progressBarType = 1;// progressBarDic->resourceType();// 强制使用PLIST类型 edit by swordman sue 2016-7-30
