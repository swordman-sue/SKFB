...
// 升级到3.2版本 add by zhuyi 2014-08-27
...
public:
	...
	// 升级到3.2版本 add by zhuyi 2014-08-25
	static  Quaternion* QuaternionRotationAxis(Quaternion* pOut,const Vec3* pV,float angle);//四元组绕给的向量旋转一定的角度
	
	static Quaternion* QuaternionRotationBetweenVec3(Quaternion* pOut, const Vec3* vec1, const Vec3* vec2, const Vec3* fallback);

	static Vec3* QuaternionMultiplyVec3(Vec3* pOut, const Quaternion* q, const Vec3* v);
	...
	// 升级到3.2版本 add by zhuyi 2014-08-27
	static Quaternion* nlerp(Quaternion* pOut, const Quaternion* q1, const Quaternion* q2, float t);
	// end
...
private:
	...
	static void scale(Quaternion* pOut,const Quaternion* pIn,float scale_);

	static Quaternion* QuaternionSub(Quaternion* pOut, const Quaternion* pQ1, const Quaternion* pQ2);

	static Quaternion* QuaternionAdd(Quaternion* pOut, const Quaternion* pQ1, const Quaternion* pQ2);
