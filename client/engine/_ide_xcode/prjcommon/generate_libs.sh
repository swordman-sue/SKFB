...
function HandlePrj()
{
    ...
    #清理项目
    #xcodebuild -project $tmp_prj_name/$tmp_prj_name.xcodeproj clean

    #编译项目
    xcodebuild -project $tmp_prj_name/$tmp_prj_name.xcodeproj -configuration $build_mode -sdk iphoneos build

    #导出静态库
    build_path=./${tmp_prj_name}/build
