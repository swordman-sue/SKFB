...
class RankingpzController extends PublicController {
    /**
     * 构造函数
     * @session   判断是否有记录
     *
    ...
    public function index(){
        ...
        $result = M('php_config')->where('type=5')->order('typeid asc')->limit($this->Page->firstRow.','.$this->Page->listRows)->select();
