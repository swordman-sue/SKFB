	...
	<body>
		...
		<div class="index-contentall">
			<div class="news-content base">
				<div class="news-top">
					<?php if(is_array($newsfl)): $i = 0; $__LIST__ = $newsfl;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="<?php if($cat_id ==$vo[cat_id]){echo 'news-active';} ?>" href="<?php echo U('News/index',array('cat_id'=>$vo[cat_id]));?>"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
				<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="media news-media">
					<div class="media-left media-middle">
						<a href="<?php echo U('News/item',array('id'=>$vo[id]));?>" target="_blank">
							<img class="media-object" src="/<?php echo ($vo["fmpicture"]); ?>" alt="">
						</a>
					</div>
					<div class="media-body">
						<a href="<?php echo U('News/item',array('id'=>$vo[id]));?>" target="_blank"><h4 class="media-heading"><?php echo ($vo["title"]); ?></h4></a>
						<small><?php echo (date("Y-m-d",$vo["date"])); ?></small>
						<p><?php echo ($vo["describe"]); ?></p>
						<a class="news-godetail" href="<?php echo U('News/item',array('id'=>$vo[id]));?>" target="_blank">详情</a>
					</div>
