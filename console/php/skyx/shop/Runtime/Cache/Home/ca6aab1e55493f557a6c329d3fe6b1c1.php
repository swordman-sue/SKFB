		...
		<div class="product-all">
			<div class="product-container base">
				<div class="product-detail service-detail">
					<h3><?php echo ($recruit["title"]); ?></h3>
					<div style="height: 2px;background: #9f9f9f;"></div>
				</div>
				<div class="mainbox">
					<div class="maincen" style=" position:relative;">
						<div class="aboutbox">
							<div class="left" style="width: 1200px;margin:0 auto;padding:0 73px;">
									<?php echo (stripslashes(htmlspecialchars_decode($recruit["content"]))); ?>
							</div>
						<div class="clear"></div>
					</div>
				</div>
