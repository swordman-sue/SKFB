	...
	<body>
		...
		<div class="index-contentall">
			<div class="news-content base">
				<div class="news-top">
					<a  style="background-color: #d5bc00;border: 1px solid #d5bc00; color: #fff;" href="javascript:0">行业知识</a>
				</div>
				<?php if(is_array($industry)): $i = 0; $__LIST__ = $industry;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="media news-media">
					<div class="media-left media-middle">
						<a href="<?php echo U('Service/ndustrytime');?>" target="_blank">
							<img class="media-object" src="/<?php echo ($vo["fmpicture"]); ?>" alt="">
						</a>
					</div>
					<div class="media-body">
						<a href="<?php echo U('Service/ndustrytime',array('id'=>$vo[id]));?>" target="_blank"><h4 class="media-heading"><?php echo ($vo["title"]); ?></h4></a>
						<small><?php echo (date("Y-m-d",$vo["date"])); ?></small>
						<p><?php echo ($vo["describe"]); ?></p>
						<a class="news-godetail" href="<?php echo U('Service/ndustrytime',array('id'=>$vo[id]));?>" target="_blank">详情</a>
					</div>
