			...
			<div class="product-container base">
				...
				<div class="product-left fl">
					<ul class="technical-ul">
						...
						<?php if(is_array($serviceclassify)): $i = 0; $__LIST__ = $serviceclassify;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
								<a class="<?php if($cat_id ==$vo[cat_id]){echo 'service-active';} ?> " href="<?php echo U('Service/index',array('cat_id'=>$vo[cat_id]));?>"><?php echo ($vo["name"]); ?></a>
							</li><?php endforeach; endif; else: echo "" ;endif; ?>
						<li>
							<a  href="<?php echo U('Service/ndustry');?> " target="_blank">行业知识</a>
						</li>
					</ul>
				...
				<div class="product-right">
					<div class="product-detail service-detail">
						...
						<p><?php echo (stripslashes(htmlspecialchars_decode($service["content"]))); ?></p>
					</div>
				</div>
			</div>
		</div>
