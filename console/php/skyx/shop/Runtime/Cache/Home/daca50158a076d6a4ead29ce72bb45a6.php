				...
				<div class="case-list">
					<ul class="fl">
						<?php if(is_array($case)): $i = 0; $__LIST__ = $case;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<a href="<?php echo U('Engineering/item',array('id'=>$vo[id]));?>&cat_id=<?php echo ($cat_id["cat_id"]); ?>" target="_blank"><img src="/<?php echo ($vo["fmpicture"]); ?>" /></a>
							<h4><?php echo ($vo["title"]); ?></h4>
							<a class="endtail" href="<?php echo U('Engineering/item',array('id'=>$vo[id]));?>&cat_id=<?php echo ($cat_id["cat_id"]); ?>" target="_blank">详情>>></a>
						</li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
				</div>
				<div class="clearfix"></div>
