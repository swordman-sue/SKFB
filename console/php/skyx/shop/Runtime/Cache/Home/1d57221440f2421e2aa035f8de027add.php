		...
		<div class="index-contentall">
			<div class="news-content base">
				...
				<div class="news-detail">
					<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="news-detaiT">
						<h3><?php echo ($vo["title"]); ?></h3>
						<small>发布时间：<?php echo (date("Y-m-d",$vo["date"])); ?></small>
						<small>作者：<?php echo ($vo["author"]); ?></small>
					</div>
					<p>
					...
					<div class="detail-go">
						<p style="text-align: center;"><?php if($pre["id"] > 0): ?><a  href="<?php echo U('News/item','id='.$pre['id']);?>">上一篇</a>
							<?php else: ?>
							上一篇：没有了!<?php endif; ?>
							<span>|</span>
							<?php if($next["id"] > 0): ?><a style="padding-right: 30px" href="<?php echo U('News/item','id='.$next['id']);?>">下一篇</a>
								<?php else: ?>
								下一篇：没有了!<?php endif; ?></p>
