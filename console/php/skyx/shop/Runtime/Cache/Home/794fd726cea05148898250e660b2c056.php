	...
	<body>
		...
		<div class="header base">
			...
			<ul class="header-ul fl">
				...
				<li>
					<a class="other <?php if(CONTROLLER_NAME == 'Brand'){echo 'active';} ?>" href="<?php echo U('Brand/indexlist');?>">产品中心</a>
				</li>
				<li>
		...
		<div class="index-content3">
					<div class="content3-a">
						<a href="#" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">人才招聘</a>
						<a href="#">在线留言</a>
						<!-- Modal -->
