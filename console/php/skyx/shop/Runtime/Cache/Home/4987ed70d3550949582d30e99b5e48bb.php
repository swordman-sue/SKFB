		...
		<div class="index-contentall">
			<div class="news-content base">
				<div class="news-detail">
					<?php if(is_array($industry)): $i = 0; $__LIST__ = $industry;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="news-detaiT">
					...
					<div class="detail-go">
						<p style="text-align: center;"><?php if($pre["id"] > 0): ?><a  href="<?php echo U('Service/ndustrytime','id='.$pre['id']);?>">上一篇</a>
							<?php else: ?>
							上一篇：没有了!<?php endif; ?>
							<span>|</span>
							<?php if($next["id"] > 0): ?><a style="padding-right: 30px" href="<?php echo U('Service/ndustrytime','id='.$next['id']);?>">下一篇</a>
								<?php else: ?>
								下一篇：没有了!<?php endif; ?></p>
