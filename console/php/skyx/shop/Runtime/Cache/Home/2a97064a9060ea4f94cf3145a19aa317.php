	...
	<body>
			...
			<div class="product-container base">
				...
				<div class="mainbox">
					<div class="maincen" style=" position:relative;">
						<div class="aboutbox">
							<div class="left fl" style="width: 48%;">
								<table class="table table-bordered table-hover">
									<tr>
										<th colspan="2">深圳市英鸿科技有限公司</th>
									</tr>
									<tr>
										<td>服务热线电话：</td>
										<td><?php echo ($contact["fwphone"]); ?></td>
									</tr>
									<tr>
										<td>客户服务邮箱：</td>
										<td><?php echo ($contact["mailbox"]); ?></td>
									</tr>
									<tr>
										<td>电话TEL：</td>
									...
									<tr>
										<td>网址WEB：</td>
										<td><?php echo ($contact["wangz"]); ?></td>
									</tr>
									<tr>
										<td>地址：</td>
										<td><?php echo ($contact["site"]); ?></td>
									</tr>
								</table>
							</div>
							<div class="right" style="float:right;" style="width: 50%;">
								<div class="conview" style="float:left;">
		...
		<script type="text/javascript">
			...
			function createMap() {
				...
				var point = new BMap.Point(114.0571096554, 22.6833239812); //定义一个中心点坐标
			...
			var markerArr = [{
				title: "深圳市英鸿科技有限公司",
				content: "座机:0755-29529730<br/>QQ:2098539341<br/>公司地址：深圳市龙华新区大和路硅谷动力园竟凯大厦3层",
				point: "114.0571096554|22.6833239812",
				isOpen: 1,
				icon: {
					w: 23,
					h: 25,
			...
			function createIcon(json) {
				var icon = new BMap.Icon("http://app.baidu.com/map//Public/Hone/images/us_mk_icon.png", new BMap.Size(json.w, json.h), {
