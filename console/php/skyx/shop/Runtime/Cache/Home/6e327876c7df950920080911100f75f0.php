...
<html>
	...
	<body>
		...
		<div class="product-all product-bg">
			<div class="product-container base product-nob">
				...
				<div class="product-left fl">
					<ul>
						<?php if(is_array($zhij)): $i = 0; $__LIST__ = $zhij;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class=" <?php if($id ==$vo[cat_id]){echo 'list-active';} ?>" href="<?php echo U('Brand/index',array('id'=>$vo[cat_id]));?>&cat_id=<?php echo ($cat_id); ?>">
							<li>
								<!--<i class="hot"><img src="/yingx/Public/Hone/images/hot.png"/></i> <!--是热门的才加这标签-->
								<?php echo ($vo["name"]); ?>
								<i class="enter"><img src="/yingx/Public/Hone/images/enter.png"/></i>
							</li>
					...
					<!--<table class="table product-tbl">
						...
						<tr>
							<td><img src="/yingx/Public/Hone/images/phone.png" /><span><?php echo ($contact["fwphone"]); ?></span></td>
						</tr>
						<tr>
							<td><img src="/yingx/Public/Hone/images/address.png" /><span> <?php echo ($contact["site"]); ?></span></td>	
						</tr>
						<tr>
							<td><img src="/yingx/Public/Hone/images/email.png" /><span><?php echo ($contact["mailbox"]); ?></span></td>
						</tr>
					</table>-->
				</div>
				...
				<div class="product-right">
					<ul class="list-ul">
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<div class="product-img">
								<a href="<?php echo U('Brand/item',array('id'=>$vo[id]));?>&cat_id=<?php echo ($cat_id); ?>" target="_blank"><img src="/<?php echo ($vo["fmpicture"]); ?>" /></a>
							</div>
							<div class="clearfix"></div>
							<div class="product-topd">
								<h4>【<?php echo ($vo["title"]); ?>】</h4>
								<p><?php echo ($vo["xingh"]); ?></p>
							</div>
							<div class="product-godetail">
								<a href="<?php echo U('Brand/item',array('id'=>$vo[id]));?>&cat_id=<?php echo ($cat_id); ?>" target="_blank">MORE</a>
							</div>
						</li><?php endforeach; endif; else: echo "" ;endif; ?>
						<?php if(is_array($listcat)): $i = 0; $__LIST__ = $listcat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<div class="product-img">
								<a href="<?php echo U('Brand/item',array('id'=>$vo[id]));?>&cat_id=<?php echo ($cat_id); ?>" target="_blank"><img src="/<?php echo ($vo["fmpicture"]); ?>" /></a>
							</div>
							<div class="clearfix"></div>
					...
					<div class="clearfix"></div>
					<nav aria-label="..." style="text-align: center;display: block;">
						<ul class="pagination">
							<b><?php echo ($page); ?></b>
							<style>
								.pagination b a ,
