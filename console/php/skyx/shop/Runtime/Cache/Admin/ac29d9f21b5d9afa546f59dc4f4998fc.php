                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo U('Admin/Brand/add');?>" class="btn btn-primary btn-xs">添加产品</a>
                        </div>
                    </div>
                    <div class="ibox-content">
                          <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">                              
                                <form action="<?php echo U('Admin/Brand/text');?>" method="get">
                                <div class="input-group">
                                    <input type="text" placeholder="请输入名称" name="" class="input-sm form-control"> <span class="input-group-btn">
                            ...
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      ...
                                      <th><i class=""></i>内容</th>
                                      <th><i class=""></i>排序</th>
                                      <th><i class=""></i>封面图片</th>
                                      <th><i class=""></i>价格</th>
                                      <th><i class=""></i>所属分类</th>
                                      <th>操作</th>
                                  </tr>
                                  <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td >
                                                <?php echo (msubstr($vo["title"],1,10)); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["xingh"]); ?>
                                            </td>
                                            <td >
                                                <?php echo (msubstr($vo["content"],1,10)); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["paix"]); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["fmpicture"]); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["price"]); ?>
                                            </td>
                                        ...
                                        <td>
                                            <a href="<?php echo U('Admin/Brand/edit','id='.$vo['id']);?>" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                                            <a href="<?php echo U('Admin/Brand/del','id='.$vo['id']);?>" class="btn btn-white btn-sm del"><i class="fa fa-trash"></i> 删除 </a>
                                        </td>
