            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Companyclassify/edit');?>" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <a class="btn btn-white" href="<?php echo U('Admin/Companyclassify/index');?>"  >取消</a>
                                    </div>
                                </div>
                        </form>
                    </div>
