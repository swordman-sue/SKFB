...
<head>
    ...
    <link href="/yingx/Public/Admin/css/plugins/iCheck/custom.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="/yingx/Public/Admin/js/kindeditor/themes/default/default.css" />
...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Brand/edit');?>" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="xingh" value="<?php echo ($result["xingh"]); ?>" style="width: 350px">
                            </div>
                        </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                    ...
                    <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">产品所属分类:</label>
                              <div class="col-sm-3">
                                ...
                                <!-- <form >
                                     <?php if(is_array($item)): $i = 0; $__LIST__ = $item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label><input type="radio" name="cat_id" value="<?php echo $vo['cat_id'] ?>" <?php if($result['cat_id']==$vo['cat_id']){ echo "radio";} ?> /> <?php echo ($vo["name"]); ?> &nbsp;&nbsp;&nbsp; &nbsp;</label><?php endforeach; endif; else: echo "" ;endif; ?>
                                 </form>-->
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <!-- 配置文件 -->
                                <script type="text/javascript" src="/yingx/Public/Admin/ueditor/ueditor.config.js"></script>
                                <!-- 编辑器源码文件 -->
                                <script type="text/javascript" src="/yingx/Public/Admin/ueditor/ueditor.all.js"></script>
                                <!-- 实例化编辑器 -->
                            ...
                            <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <a class="btn btn-white" href="<?php echo U('Admin/Brand/index');?>"  >取消</a>
                                    </div>
                                </div>
                        </form>
                    </div>
    ...
    <script src="/yingx/Public/Admin/js/plugins/layer/laydate/laydate.js"></script>
    <script src="/yingx/Public/Admin/js/plugins/iCheck/icheck.min.js"></script>
	<script charset="utf-8" src="/yingx/Public/Admin/js/kindeditor/kindeditor-min.js"></script>
	<script charset="utf-8" src="/yingx/Public/Admin/js/kindeditor/lang/zh_CN.js"></script>
 <script>
        var editor;
...
</script><script type="text/javascript" src="/yingx/Public/Admin/js/datetime.js"></script>
</html>