            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Picture/edit');?>" class="form-horizontal" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo ($result["id"]); ?>" />
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">图片名字</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" name="tpname" value="<?php echo ($result["tpname"]); ?>">
                                    </div>
                                </div>
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">图片所属分类</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <a class="btn btn-white" href="<?php echo U('Admin/Picture/index');?>"  >取消</a>
                                    </div>
                                </div>
                        </form>
                    </div>
