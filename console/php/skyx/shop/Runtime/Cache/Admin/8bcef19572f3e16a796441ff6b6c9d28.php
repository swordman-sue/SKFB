                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                          <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">                              
                                <form action="<?php echo U('Admin/Log/text');?>" method="post">
                            ...
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      ...
                                      <th><i class=""></i>充值ID</th>
                                      <th><i class=""></i>充值类型</th>
                                      <th><i class=""></i>是否测试模式</th>
                                      <th><i class=""></i>渠道</th>
                                      <th><i class=""></i>渠道uid</th>
                                      <th><i class=""></i>cp订单号</th>
                                      <th><i class=""></i>sdk订单号</th>
                                      <th><i class=""></i>支持时间</th>
                                      <th><i class=""></i>记录时间</th>
                                      <th><i class=""></i>充值额度</th>
                                      <th><i class=""></i>状态</th>
                                      <th><i class=""></i>穿透参数</th>
                                  </tr>
                                  <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td >
                                                <?php echo ($vo["recharge_id"]); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["recharge_type"]); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["is_test"]); ?>
                                            </td>
                                            ...
                                            <td >
                                                <?php echo ($vo["channel_uid"]); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["game_order"]); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["order_no"]); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["pay_time"]); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["record_time"]); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["amount"]); ?>
                                            </td>
