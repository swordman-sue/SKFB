        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>五条发放奖励</h5>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="<?php echo U('Admin/Award/add');?>" class="btn btn-primary btn-xs">单条发放奖励</a>
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Award/duoadd');?>" class="form-horizontal" enctype='multipart/form-data'>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">发放奖励时间</label>
                                <div class="col-sm-3">
                                    <input type="text" style="width:310px;height:35px" class="sang_Calender" name="add_time">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div>
                                    <p style="width: 800px;">
                                        <label style="margin-left: 80px;">(指定服务器选:8)</br>(0指定玩家:7)</label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        指定玩家<input  type="radio" id="cmd_id" name="cmd_id" value="7" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        指定服务器<input  type="radio" id="cmd_id" name="cmd_id" value="8" />
                                    </p>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">指定的玩家ID(0表示发放整个服务器玩家)五个玩家ID发放</label>
                                <div id="uploads" class="col-sm-3">
                                    <input type="text" class="form-control" name="param1">
                                    <input type="text" class="form-control" name="param11">
                                    <input type="text" class="form-control" name="param12">
                                    <input type="text" class="form-control" name="param13">
                                    <input type="text" class="form-control" name="param14">
                                </div>
                                <!--<p>-->
                                <!--<input type="button" value="增加玩家ID" id="addUpload">-->
                                <!--</p>-->
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">(选择下啦奖励ID)：</label>
                                <div class="col-sm-3">
                                    <select name="param5" class="form-control">
                                        <option value="">..请选择</option>
                                        <?php if(is_array($jianl)): $i = 0; $__LIST__ = $jianl;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option  value="<?php echo ($vo['typeid']); ?>" <?php if($vo['typeid'] == $resut['param5']): ?>selected<?php endif; ?> >
                                            <?php echo ($vo['typeid']); ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <?php echo ($vo['name']); ?>
                                            </option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                    <!--<label >奖励ID(选择下啦就不用输，没选下拉就输)：</label>-->
                                    <!--<input type="text" class="form-control" name="param3">-->
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">(选择下啦奖励物品ID)：</label>
                                <div class="col-sm-3">
                                    <select name="param3" class="form-control">
                                        <option value="">..请选择</option>
                                        <?php if(is_array($wuping)): $i = 0; $__LIST__ = $wuping;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option  value="<?php echo ($vo['typeid']); ?>" <?php if($vo['typeid'] == $resut['param3']): ?>selected<?php endif; ?> >
                                            <?php echo ($vo['typeid']); ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <?php echo ($vo['name']); ?>
                                            </option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                    <!--<label >奖励物品ID(选择下啦就不用输，没选下拉就输)：</label>-->
                                    <!--<input type="text" class="form-control" name="param4">-->
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">奖励物品数量(必填)：</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="param4">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">奖励描述(暂时不起作用)：</label>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <a class="btn btn-white" href="<?php echo U('Admin/Award/add');?>"  >重置</a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    $(function(){
        ...
        $('#addUpload').click(function(){
            uno++;
            $('#uploads').append('<input type="text" class="form-control" name="param1">');
        });
    });
