            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Recruit/add');?>" class="form-horizontal" enctype='multipart/form-data'>
                            ...
                            <div class="hr-line-dashed"></div>-->
                            <div class="form-group">
                                <label class="col-sm-2 control-label">公司介绍分类</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <a class="btn btn-white" href="<?php echo U('Admin/Recruit/index');?>"  >取消</a>
                                </div>
                            </div>
                        </form>
                    </div>
