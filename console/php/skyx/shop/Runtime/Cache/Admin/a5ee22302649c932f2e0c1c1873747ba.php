                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Service/add');?>" class="form-horizontal" enctype='multipart/form-data'>
                            ...
                            <div class="form-group">
                                ...
                                <!-- 配置文件 -->
                                <script type="text/javascript" src="/skyx/Public/Admin/ueditor/ueditor.config.js"></script>
                                <!-- 编辑器源码文件 -->
                                <script type="text/javascript" src="/skyx/Public/Admin/ueditor/ueditor.all.js"></script>
                                <!-- 实例化编辑器 -->
