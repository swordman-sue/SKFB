                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                          <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">                              
                                <form action="<?php echo U('Admin/Recharge/text');?>" method="post">
                            ...
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      ...
                                      <th><i class=""></i>服务器ID</th>
                                      <th><i class=""></i>充值ID</th>
                                      <th><i class=""></i>月卡ID</th>
                                      <th><i class=""></i>充值额度</th>
                                      <th><i class=""></i>获得的钻石</th>
                                      <th><i class=""></i>充值时间</th>
                                      <th><i class=""></i>定单ID</th>
                                      <th><i class=""></i>支付时间</th>
                                  </tr>
