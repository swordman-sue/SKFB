            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Industry/add');?>" class="form-horizontal" enctype='multipart/form-data'>
                            ...
                            <div class="col-sm-3">
                                <input type="text" style="width:230px;height:35px" class="sang_Calender" name="date">
                            </div>
                        </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <textarea style="width:500px;height:150px;" name="describe" value="describe" ></textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <a class="btn btn-white" href="<?php echo U('Admin/Industry/index');?>"  >取消</a>
                                </div>
                            </div>
                        </form>
                    </div>
