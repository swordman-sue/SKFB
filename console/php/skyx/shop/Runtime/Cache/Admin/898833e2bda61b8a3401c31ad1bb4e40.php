                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11" style="width: 230px; display: inline;">
                                <form action="<?php echo U('Admin/Logout/text');?>" method="post">
                                    <div class="input-group">
                                        <input type="text" style="width:170px;" placeholder="请输入ID排序" name="idx"  class="input-sm form-control"> <span class="input-group-btn">
                                    <button type="submit" class="btn btn-sm btn-primary" style="margin-right: 1100px;" > 搜索</button> </span>
                                    </div>
                                </form>
                            </div>
                            <div class="col-md-11" style="width: 230px; display: inline;">
                                <form action="<?php echo U('Admin/Logout/chaname');?>" method="post">
                                    <div class="input-group">
                                        <input type="text" style="width:170px;" placeholder="请输入角色名字" name="role_name"  class="input-sm form-control"> <span class="input-group-btn">
                                    <button type="submit" class="btn btn-sm btn-primary" style="margin-right: 1100px;" > 搜索</button> </span>
                                    </div>
                                </form>
                            </div>
                            <div class="col-md-11" style="width: 320px; display: inline;">
                                <form action="<?php echo U('Admin/Logout/cahzhuans');?>" method="post">
                                    <div class="input-group">
                            ...
                            <div class="col-md-11" style="width: 320px; display: inline;">
                                <form action="<?php echo U('Admin/Logout/cahdengj');?>" method="post">
                                    <div class="input-group">
                                        <input type="text" style="width:120px;margin-right: 12px;"  placeholder="请输入最小等级!等级之间查找" name="level1" class="input-sm form-control"><span class="input-group-btn">
                                          <input type="text" style="width:120px;"  placeholder="请输入最大等级!等级之间查找" name="level2" class="input-sm form-control">
                                    <button type="submit" class="btn btn-sm btn-primary" style="margin-right: 1100px;"> 搜索</button> </span>
                                    </div>
                                </form>
                            </div>
                            ...
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      ...
                                      <th><i class=""></i>钻石</th>
                                      <th><i class=""></i>金币</th>
                                      <th><i class=""></i>在线时间秒</th>
                                      <th><i class=""></i>最后在线时间</th>
                                      <th><i class=""></i>chapter</th>
                                      <th><i class=""></i>map</th>
                                      <th><i class=""></i>强制指定x</th>
                                      <th><i class=""></i>强制指定y</th>
                                  </tr>
                                  <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td >
                                                <?php echo ($vo["online_time"]); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["offline_time"]); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["chapter"]); ?>
                                            </td>
