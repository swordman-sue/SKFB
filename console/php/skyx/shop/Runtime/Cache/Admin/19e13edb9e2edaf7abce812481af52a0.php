                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo U('Admin/Companyclassify/add');?>" class="btn btn-primary btn-xs">添加公司介绍分类</a>
                        </div>
                    </div>
                    <div class="ibox-content">
                          <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">                              
                                <form action="<?php echo U('Admin/Companyclassify/text');?>" method="get">
                        ...
                        <div class="project-list">
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      <th>ID</th>
                                      <th><i class="fa fa-user"></i>公司介绍分类名字</th>
                                      <th>操作</th>
                                  </tr>
                                  <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <a href="<?php echo U('Admin/Companyclassify/edit','id='.$vo['cat_id']);?>" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                                            <a href="<?php echo U('Admin/Companyclassify/del','id='.$vo['cat_id']);?>" class="btn btn-white btn-sm del"><i class="fa fa-trash"></i> 删除 </a>
                                        </td>
