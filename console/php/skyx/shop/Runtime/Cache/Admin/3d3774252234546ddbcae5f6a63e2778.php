                ...
                <div class="ibox-content">
                    <div class="row m-b-sm m-t-sm">
                        ...
                        <div class="col-md-11" style="width: 250px; display: inline;">
                            <form action="<?php echo U('Admin/Record/text');?>" method="post">
                        ...
                        <div class="col-md-11" style="width: 320px; display: inline;">
                            <form action="<?php echo U('Admin/Record/chazhangj');?>" method="post">
                                <div class="input-group">
                                    <input type="text" style="width:120px;margin-right: 12px;"  placeholder="请输入最小章节!章节之间查找" name="chapter1" class="input-sm form-control"><span class="input-group-btn">
                                          <input type="text" style="width:120px;"  placeholder="请输入最大章节!章节之间查找" name="chapter2" class="input-sm form-control">
                                    <button type="submit" class="btn btn-sm btn-primary" style="margin-right: 1100px;"> 搜索</button> </span>
                                </div>
                            </form>
                        </div>
                        <div class="col-md-11" style="width: 320px; display: inline;">
                            <form action="<?php echo U('Admin/Record/cahzhangli');?>" method="post">
                                <div class="input-group">
                                    <input type="text" style="width:120px;margin-right: 12px;"  placeholder="请输入最小战力!战力之间查找" name="zhanl1" class="input-sm form-control"><span class="input-group-btn">
                                          <input type="text" style="width:120px;"  placeholder="请输入最大战力!战力之间查找" name="zhanl2" class="input-sm form-control">
                                    <button type="submit" class="btn btn-sm btn-primary" style="margin-right: 1100px;"> 搜索</button> </span>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="project-list">
                        <table class="table table-hover" style="text-align:center">
                            ...
                            <tr>
                                <th>角色Id</th>
                                <th>角色名字</th>
                                <th><i class=""></i>关卡类型</th>
                                <th><i class=""></i>关卡ID</th>
                                <th><i class=""></i>章节</th>
                                <th><i class=""></i>关卡索引</th>
                                <th><i class=""></i>失败次数</th>
                                <th><i class=""></i>战力</th>
                            </tr>
