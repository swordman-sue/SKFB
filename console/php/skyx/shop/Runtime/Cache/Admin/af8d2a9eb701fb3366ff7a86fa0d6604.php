                    ...
                    <div class="ibox-content">
                        <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11" style="width: 250px; display: inline;">
                                <form action="<?php echo U('Admin/Usercurrency/text');?>" method="post">
                                    <div class="input-group">
                                        <input type="text" style="width:170px;" placeholder="请输入名字" name="role_name" class="input-sm form-control"> <span class="input-group-btn">
                            ...
                            <div class="col-md-11" style="width: 320px; display: inline;">
                                <form action="<?php echo U('Admin/Usercurrency/cahshij');?>" method="post">
                                    <div class="input-group">
                                        <input type="text" style="width:120px;margin-right: 12px;"  placeholder="请输入最小时间!时间之间查找" name="time1" class="input-sm form-control"><span class="input-group-btn">
                                          <input type="text" style="width:120px;"  placeholder="请输入最大时间!时间之间查找" name="time2" class="input-sm form-control">
                                    <button type="submit" class="btn btn-sm btn-primary" style="margin-right: 1100px;"> 搜索</button> </span>
                                    </div>
                                </form>
                            </div>
                            ...
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      ...
                                      <th><i class=""></i>货币类型</th>
                                      <th><i class=""></i>货币值</th>
                                      <th><i class=""></i>当前货币值</th>
                                      <th><i class=""></i>来源描述</th>
                                      <th><i class=""></i>写入时间</th>
                                  </tr>
