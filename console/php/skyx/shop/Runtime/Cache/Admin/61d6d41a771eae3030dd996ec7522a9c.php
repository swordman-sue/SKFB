            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Noticepz/edit');?>" class="form-horizontal" enctype='multipart/form-data'>
                            <div class="form-group">
                                <input type="hidden" name="id" value="<?php echo ($result["id"]); ?>" />
                                <label class="col-sm-2 control-label">排序</label>
                                <div class="col-sm-3">
                                    <input  class="form-control" name="typeid" value="<?php echo ($result["typeid"]); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">类型(*填1*)</label>
                                <div class="col-sm-3">
                                    <input  class="form-control" name="type" value="<?php echo ($result["type"]); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">内容</label>
                                <textarea name="name" rows="8" cols="80"><?php echo ($result["name"]); ?></textarea>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <button class="btn btn-primary" type="submit">编辑</button>
                                    <a class="btn btn-white" href="<?php echo U('Admin/Noticepz/index');?>"  >取消</a>
                                </div>
                            </div>
                        </form>
                    </div>
