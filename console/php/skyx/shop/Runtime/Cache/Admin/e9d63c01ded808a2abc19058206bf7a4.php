            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Brandclassify/add');?>" class="form-horizontal" enctype='multipart/form-data'>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">子类名字</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">所属分类，顶级不用选</label>
                                <div class="col-sm-3">
                                    <select name="pid" class="form-control">
                                        <option value="">..请选择</option>
                                        <?php if(is_array($fenlei)): $i = 0; $__LIST__ = $fenlei;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option  value="<?php echo ($vo['cat_id']); ?>" <?php if($vo['cat_id'] == $resut['pid']): ?>selected<?php endif; ?> >
                                            <?php echo ($vo['name']); ?>
