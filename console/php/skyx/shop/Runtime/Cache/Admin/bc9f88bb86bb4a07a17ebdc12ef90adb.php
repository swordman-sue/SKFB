                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo U('Admin/Picture/add');?>" class="btn btn-primary btn-xs">添加新页面图片</a>
                        </div>
                    </div>
                    <div class="ibox-content">
                          <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">                              
                                <form action="<?php echo U('Admin/Picture/text');?>" method="get">
                        ...
                        <div class="project-list">
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      <th>ID</th>
                                      <th><i class="fa fa-user"></i>图片名字</th>
                                      <th><i class="">图片</th>
                                      <th><i class="">图片所属分类</th>
                                      <th><i class="">排序</th>
                                      <th>操作</th>
                                  </tr>
                                  <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <a href="<?php echo U('Admin/Picture/edit','id='.$vo['id']);?>" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                                            <a href="<?php echo U('Admin/Picture/del','id='.$vo['id']);?>" class="btn btn-white btn-sm del"><i class="fa fa-trash"></i> 删除 </a>
                                        </td>
