        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>单发放奖励</h5>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="<?php echo U('Admin/Award/duoadd');?>" class="btn btn-primary btn-xs">五条发放奖励</a>
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Award/add');?>" class="form-horizontal" enctype='multipart/form-data'>
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">指定的玩家ID(0表示发放整个服务器玩家)</label>
