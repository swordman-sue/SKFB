                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo U('Admin/Noticepz/add');?>" class="btn btn-primary btn-xs">新增公告配置</a>
                        </div>
                    </div>
                    <div class="ibox-content">
                          <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">                              
                                <form action="<?php echo U('Admin/Server/text');?>" method="post">
                            ...
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  ...
                                  <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <a href="<?php echo U('Admin/Noticepz/edit','id='.$vo['id']);?>" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                                            <a href="<?php echo U('Admin/Noticepz/del','id='.$vo['id']);?>" class="btn btn-white btn-sm del"><i class="fa fa-trash"></i> 删除 </a>
                                        </td>
