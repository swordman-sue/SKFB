            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Service/add');?>" class="form-horizontal" enctype='multipart/form-data'>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">标题</label>
                                <div class="col-sm-3">
                                    <input style="width: 520px" type="text" class="form-control" name="title">
                                </div>
                            </div>
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">技术服务分类</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <label >内容</label>
                                <!-- 加载编辑器的容器 -->
                                <script id="aboutus" name="content" type="text/plain" style="width:1000px;height:300px" ></script>
                                <!-- 配置文件 -->
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <a class="btn btn-white" href="<?php echo U('Admin/Service/index');?>"  >取消</a>
                                </div>
                            </div>
                        </form>
                    </div>
