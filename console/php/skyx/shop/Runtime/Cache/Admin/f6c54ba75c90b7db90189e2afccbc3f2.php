            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Productlist/edit');?>" class="form-horizontal" enctype="multipart/form-data" onsubmit="getContent()">
                            <input type="hidden" name="id" value="<?php echo ($result["id"]); ?>" />
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">封面图</label>
                                <div class="col-sm-10">
                                    <img src="/<?php echo ($result["picture"]); ?>" class="img-circle" alt="" width="50px" height="50px">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select name="listid" id="" class="form-control">
                                        <option value="">..请选择</option>
                                        <?php if(is_array($zhij)): $i = 0; $__LIST__ = $zhij;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cat_id"]); ?>" <?php echo ($vo['cat_id']==$result['listid']?'selected':''); ?>>
                                            <?php echo ($vo["name"]); ?>
                                            </option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            ...
                            <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <a class="btn btn-white" href="<?php echo U('Admin/Productlist/index');?>" >取消</a>
                                    </div>
                                </div>
                        </form>
                    </div>
