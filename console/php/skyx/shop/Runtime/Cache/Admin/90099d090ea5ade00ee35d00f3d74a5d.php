            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Brand/add');?>" class="form-horizontal" enctype='multipart/form-data'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input style="width: 380px" type="text" class="form-control" name="xingh">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">所属产品分类</label>
                                <div class="col-sm-3">
