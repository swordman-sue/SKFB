                    ...
                    <div class="ibox-content">
                          <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">                              
                                ...
                                <!--<div class="input-group">-->
                                    <!--<input type="text" style="width:170px;" placeholder="请输入角色Id" name="role_id" class="input-sm form-control"> <span class="input-group-btn">-->
                        ...
                        <div class="project-list">
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      <th style="float: left;margin-left: 150px">购买类型</th>
                                      <th style="float: left;margin-left: 150px"><i class=""></i>商成ID</th>
                                      <th style="float: left;margin-left: 150px"><i class=""></i>购买码</th>
                                  </tr>
                                  <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><table border="1" style="margin-left: 150px;">
                                    <tr>
                                            <td style="width: 160px;text-align: center;">
                                                <?php echo ($vo["shop_type"]); ?>
                                            </td>
                                            <td style="width: 160px;text-align: center;">
