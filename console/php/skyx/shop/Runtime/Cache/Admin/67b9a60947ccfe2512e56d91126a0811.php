                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                          <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">                              
                                <!--<form action="<?php echo U('Admin/Activation/text');?>" method="post">-->
                                <!--<div class="input-group">-->
                                    <!--<input type="text" style="width:170px;"  placeholder="请输入索引ID" name="role_name" class="input-sm form-control"> <span class="input-group-btn">-->
                        ...
                        <div class="project-list">
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      <th><i class=""></i>领取角色ID</th>
                                      <th><i class=""></i>角色名字</th>
                                      <th><i class=""></i>激活码</th>
                                      <th><i class=""></i>领取时间</th>
                                  </tr>
