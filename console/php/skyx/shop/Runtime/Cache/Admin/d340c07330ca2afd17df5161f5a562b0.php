                    ...
                    <div class="ibox-content">
                        <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11" style="width: 250px; display: inline;">
                                <form action="<?php echo U('Admin/First/text');?>" method="post">
                            ...
                            <div class="col-md-11" style="width: 320px; display: inline;">
                                <form action="<?php echo U('Admin/First/cahzhangj');?>" method="post">
                                    <div class="input-group">
                            ...
                            <div class="col-md-11" style="width: 320px; display: inline;">
                                <form action="<?php echo U('Admin/First/dengj');?>" method="post">
                                    <div class="input-group">
                        ...
                        <div class="project-list">
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      <th>索引ID</th>
                                      <th><i class=""></i>角色Id</th>
                                      <th><i class=""></i>角色名字</th>
