            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo U('Admin/Server/add');?>" class="form-horizontal" enctype='multipart/form-data'>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">服务器ID</label>
                                <div class="col-sm-3">
                                    <input  class="form-control" name="server_id">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" style="width:230px;height:35px" class="sang_Calender" name="open_time">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <button class="btn btn-primary" type="submit">开服</button>
                                    <a class="btn btn-white" href="<?php echo U('Admin/Server/index');?>"  >取消</a>
                                </div>
                            </div>
                        </form>
                    </div>
