                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo U('Admin/News/add');?>" class="btn btn-primary btn-xs">添加新闻</a>
                        </div>
                    </div>
                    <div class="ibox-content">
                          <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">                              
                                <form action="<?php echo U('Admin/Name/text');?>" method="get">
                                <div class="input-group">
                                    <input type="text" placeholder="请输入页面图片名称" name="" class="input-sm form-control"> <span class="input-group-btn">
                            ...
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  ...
                                  <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <a href="<?php echo U('Admin/News/edit','id='.$vo['id']);?>" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                                            <a href="<?php echo U('Admin/News/del','id='.$vo['id']);?>" class="btn btn-white btn-sm del"><i class="fa fa-trash"></i> 删除 </a>
                                        </td>
