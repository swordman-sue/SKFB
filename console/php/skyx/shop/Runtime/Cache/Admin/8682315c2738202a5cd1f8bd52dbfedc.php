                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                          <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">                              
                                <form action="<?php echo U('Admin/Guild/text');?>" method="post">
                                <div class="input-group">
                                    <input type="text" style="width:170px;" placeholder="请输入工会ID" name="guild_id" class="input-sm form-control"> <span class="input-group-btn">
                        ...
                        <div class="project-list">
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      <th style="float: left;margin-left: 150px">工会ID</th>
                                      <th style="float: left;margin-left: 150px"><i class=""></i>工会所属服务器ID</th>
                                      <th style="float: left;margin-left: 150px"><i class=""></i>工会名称</th>
                                  </tr>
                                  <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <td style="float: left;margin-left: 150px">
                                                <?php echo ($vo["guild_id"]); ?>
                                            </td>
                                            <td style="float: left;margin-left: 150px">
                                                <?php echo ($vo["name"]); ?>
                                            </td>
                                            <td style="float: left;margin-left: 220px">
                                                <?php echo ($vo["guild_name"]); ?>
                                            </td>
                                        <!--<td>-->
