                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo U('Admin/Adminuser/add');?>" class="btn btn-primary btn-xs">添加新管理员</a>
                        </div>
                    </div>
                    <div class="ibox-content">
                          <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">                              
                                <form action="<?php echo U('Admin/Adminuser/index');?>" method="get">
                                <div class="input-group">
                                    <input type="text" placeholder="请输入名称" name="search" class="input-sm form-control"> <span class="input-group-btn">
                                    <button disabled="disabled" type="submit" class="btn btn-sm btn-primary"> 搜索</button> </span>
                                </div>        
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="project-list">
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      <th>ID</th>
                                      <th><i class="fa fa-user"></i>管理员账号</th>
                                      <th><i class="fa fa-user"></i>管理员密码</th>
                                      <th><i class="fa fa-user"></i>管理员昵称</th>
                                      <th><i class="fa fa-user"></i>管理员级别(普通管理员)</th>
                                      <th>操作</th>
                                  </tr>
                                  <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td >
                                                <?php echo ($vo["admin_password"]); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["admin_nickname"]); ?>
                                            </td>
                                            <td >
                                                <?php echo ($vo["class"]); ?>
                                            </td>
                                        <td>
                                            <a href="<?php echo U('Admin/Adminuser/edit','id='.$vo['admin_id']);?>" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                                        </td>
