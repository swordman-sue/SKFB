                            ...
                            <table class="table table-hover" style="text-align:center">
                                <tbody>
                                  <tr>
                                      ...
                                      <th><i class=""></i>总的在线时间秒(转换时间格式)</th>
                                  ...
                                  <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="no1">
                                            <td >
                                                <?php echo ($vo["role_id"]); ?>
                                            </td>
                                            <td >
                                        ...
                                        <td>
                                            <a href="<?php echo U('Admin/Role/edit','role_id='.$vo['role_id']);?>" class="btn btn-white btn-sm" style="background-color: #2a62bc;color: #FFF;"><i></i> 详情 </a>
