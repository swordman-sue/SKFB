...
void MD5::md5_append(md5_state_t *pms, const md5_byte_t *data, size_t nbytes)
{
...
MD5::Digest MD5::Encode(std::string const& s)
{
    return Encode(s.c_str(), (int)s.size());
}
...
std::string MD5::Digest::HexString() const
{
